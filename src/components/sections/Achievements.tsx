  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 -right-32 w-64 h-64 bg-accent-purple/10 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/4 -left-32 w-64 h-64 bg-accent-cyan/10 rounded-full blur-[100px]" />
      </div>
