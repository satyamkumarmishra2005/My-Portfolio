          ...
          <div className="flex gap-2 flex-shrink-0">
            {project.githubUrl && (
              <a
                ...
                className="p-2 sm:p-2.5 rounded-lg bg-bg-tertiary hover:bg-accent-blue/20 text-text-muted hover:text-accent-blue transition-all duration-300 touch-manipulation active:scale-95"
            ...
            {project.liveUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 sm:p-2.5 rounded-lg bg-bg-tertiary hover:bg-accent-cyan/20 text-text-muted hover:text-accent-cyan transition-all duration-300 touch-manipulation active:scale-95"
