  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 -right-32 w-[500px] h-[500px] bg-accent-purple/5 rounded-full blur-[150px]" />
        <div className="absolute bottom-1/3 -left-32 w-[400px] h-[400px] bg-accent-blue/5 rounded-full blur-[120px]" />
      </div>
        ...
        <motion.div {...scrollRevealConfig} variants={containerVariants}>
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl glass-card text-text-primary font-medium hover:border-accent-blue/30 transition-all duration-300 group"
            >
